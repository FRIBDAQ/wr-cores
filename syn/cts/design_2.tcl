...
# module references:
# CTSExtensionMux, cts_top, spi_to_i2c_bridge
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set CTSExtensionMux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CTSExtensionMux_0 eq "" } {
...
1#Gem 1#Gem 1#Gem 1#Gem 1#MDIO 1#MDIO 1#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#GPIO2 MIO#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB\
1#USB 1#USB 1#USB 1#USB 1#GPIO2 MIO#USB1 Reset} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#sclk_out#gpio0[7]#gpio0[8]#n_ss_out[0]#miso#mosi#gpio0[12]#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#scl_out#sda_out#gpio1[26]#gpio1[27]#gpio1[28]#gpio1[29]#gpio1[30]#gpi[5]#gpio1[32]#gpio1[33]#gpio1[34]#gpo[3]#txd#rxd#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem1_mdc#gem1_mdio_out#gpio2[52]#gpio2[53]#gpio2[54]#gpio2[55]#gpio2[56]#gpio2[57]#gpio2[58]#gpio2[59]#gpio2[60]#gpio2[61]#gpio2[62]#gpio2[63]#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#gpio2[76]#reset}\
\
...
\
  ...
  # Create instance: spi_to_i2c_bridge_0, and set properties
  set block_name spi_to_i2c_bridge
  set block_cell_name spi_to_i2c_bridge_0
  if { [catch {set spi_to_i2c_bridge_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spi_to_i2c_bridge_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net CTSExtensionMux_0_scl_o [get_bd_pins LEMO_IN_3/IBUF_OUT] [get_bd_pins LEMO_OUT_3/OBUF_IN] [get_bd_pins LEMO_OUT_2/OBUF_IN]
  ...
  connect_bd_net -net Net [get_bd_ports P1_HPIO1_p] [get_bd_pins spi_to_i2c_bridge_0/sda]
  connect_bd_net -net Net1 [get_bd_ports P1_HPIO1_n] [get_bd_pins spi_to_i2c_bridge_0/scl]
  ...
  connect_bd_net -net cts_top_0_clk_ref_50m_o [get_bd_pins cts_top_0/clk_ref_50m_o] [get_bd_pins spi_to_i2c_bridge_0/clock]
  ...
  connect_bd_net -net cts_top_0_pll20dac_cs_n_o [get_bd_pins cts_top_0/pll20dac_cs_n_o] [get_bd_pins CTSExtensionMux_0/A1_i] [get_bd_pins spi_to_i2c_bridge_0/ss_n]
  connect_bd_net -net cts_top_0_pll25dac_cs_n_o [get_bd_pins cts_top_0/pll25dac_cs_n_o] [get_bd_pins CTSExtensionMux_0/A0_i]
  connect_bd_net -net cts_top_0_plldac_din_o [get_bd_pins cts_top_0/plldac_din_o] [get_bd_pins CTSExtensionMux_0/plldac_din_i] [get_bd_pins spi_to_i2c_bridge_0/mosi]
  connect_bd_net -net cts_top_0_plldac_sclk_o [get_bd_pins cts_top_0/plldac_sclk_o] [get_bd_pins CTSExtensionMux_0/plldac_sclk_i] [get_bd_pins spi_to_i2c_bridge_0/sclk]
  ...
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins util_vector_logic_2/Res] [get_bd_pins spi_to_i2c_bridge_0/reset_n]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_2/Op1]
