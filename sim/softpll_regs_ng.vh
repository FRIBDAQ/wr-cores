...
`define ADDR_SPLL_AL_CREF              7'hc
`define ADDR_SPLL_AL_CIN               7'h10
`define ADDR_SPLL_DMTD_STAT_CR         7'h14
...
`define ADDR_SPLL_DMTD_STAT_VAL        7'h18
...
`define ADDR_SPLL_RCER                 7'h24
`define ADDR_SPLL_OCER                 7'h28
`define ADDR_SPLL_DAC_HPLL             7'h40
`define ADDR_SPLL_DAC_MAIN             7'h44
...
`define ADDR_SPLL_DEGLITCH_THR         7'h48
`define ADDR_SPLL_DFR_SPLL             7'h4c
...
`define ADDR_SPLL_TRR_CSR              7'h74
