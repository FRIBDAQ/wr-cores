...
`define ADDR_EP_MACH                   6'h24
`define ADDR_EP_MACL                   6'h28
`define ADDR_EP_MDIO_CR                6'h2c
...
`define ADDR_EP_IDCODE                 6'h34
`define ADDR_EP_DSR                    6'h38
...
`define EP_DSR_RXSYNC_OFFSET 2
`define EP_DSR_RXSYNC 32'h00000004
`define EP_DSR_GTREADY_OFFSET 3
`define EP_DSR_GTREADY 32'h00000008
`define ADDR_EP_INJ_CTRL               6'h3c
