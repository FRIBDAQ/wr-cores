...
# create the system "arria10_sys_pll_default"
proc do_create_arria10_sys_pll_default {} {
	# create the system
	create_system arria10_sys_pll_default
	...
	set_instance_parameter_value iopll_0 {gui_reference_clock_frequency_ps} {8000.0}
...
<bonusData>
 <element __value="iopll_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	set_module_property FILE {arria10_sys_pll_default.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {arria10_sys_pll_default}

	# save the system
	sync_sysinfo_parameters
	save_system arria10_sys_pll_default
}

# create all the systems, from bottom up
do_create_arria10_sys_pll_default
