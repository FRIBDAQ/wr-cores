...
xilinx_ip_gthe4_lp_125 = [
    "xilinx-ip/gthe4_lp/ref_clk_125/gtwizard_ultrascale_2.v",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_2_gtwizard_top.v",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_2.xdc",
    "xilinx-ip/gthe4_lp/ref_clk_125/gtwizard_ultrascale_2_gthe4_channel_wrapper.v",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_2_gtwizard_gthe4.v",
    "xilinx-ip/gthe4_lp/ref_clk_125/gtwizard_ultrascale_2_ooc.xdc",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_v1_7_gthe4_channel.v"
];

xilinx_ip_gthe4_lp_100 = [
    "xilinx-ip/gthe4_lp/ref_clk_100/gtwizard_ultrascale_2.v",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_2_gtwizard_top.v",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_2.xdc",
    "xilinx-ip/gthe4_lp/ref_clk_100/gtwizard_ultrascale_2_gthe4_channel_wrapper.v",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_2_gtwizard_gthe4.v",
    "xilinx-ip/gthe4_lp/ref_clk_100/gtwizard_ultrascale_2_ooc.xdc",
    "xilinx-ip/gthe4_lp/gtwizard_ultrascale_v1_7_gthe4_channel.v"
];
...
if (syn_device[0:4].upper()=="XC6S"): # Spartan6
    ...
    # PHY reference clock is default 125 MHz; check if 100 MHz is defined
    try:
        if (ref_clk=="100"):
            files.extend( xilinx_ip_gthe4_lp_100 ); # Note that gthe4 depend on Vivado version
        else:
            files.extend( xilinx_ip_gthe4_lp_125 ); # Note that gthe4 depend on Vivado version
    except:
        files.extend( xilinx_ip_gthe4_lp_125 );     # Note that gthe4 depend on Vivado version
