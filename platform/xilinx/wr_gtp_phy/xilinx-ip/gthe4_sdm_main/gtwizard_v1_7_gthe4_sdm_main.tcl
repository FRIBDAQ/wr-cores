set module_name {gtwizard_v1_7_gthe4_sdm_main}
...
set_property -dict [list \
  CONFIG.CHANNEL_ENABLE {X0Y9 X0Y8} \
  ...
  CONFIG.RX_MASTER_CHANNEL {X0Y9} \
  CONFIG.RX_REFCLK_SOURCE {X0Y9 clk1 X0Y8 clk1} \
  ...
  CONFIG.TX_REFCLK_SOURCE {X0Y9 clk0 X0Y8 clk0} \
  CONFIG.TXPROGDIV_FREQ_ENABLE {true} \
  CONFIG.TXPROGDIV_FREQ_VAL {62.5} \
  CONFIG.TX_MASTER_CHANNEL {X0Y9} \
