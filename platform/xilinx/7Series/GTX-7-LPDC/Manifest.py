...
if (syn_device[0:4].upper()=="XC7K" or # Family 7 GTX (Kintex7 and Virtex7 585, 2000, X485 and ZYNQ Z030,Z035 Z045)
    ...
    syn_device[0:7].upper()=="XC7Z045"):
		files = ["wr_gtx_phy_kintex7_lp.vhd",        #Kintex-7 specific files
                 "wr_gtx_phy_kintex7_lp_qpll.vhd",
                 "gtx_comma_detect_kintex7_lp.vhd",
                 "gtx_idle_detect_kintex7_lp.vhd",
                 "whiterabbit_gtxe2_channel_wrapper_kintex7_lp.vhd",
                 "../../common/lpdc_mdio_regs.vhd",
                 "wr_gtx_phy_family7_lp.vhd",       #GTX-7 files
                 "gtx_comma_detect_lp.vhd",
                 "whiterabbit_gtxe2_channel_wrapper_gt_lp.vhd",
                ]
